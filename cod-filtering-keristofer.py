...
print(Fore.YELLOW + "")
time.sleep(1.7)
print("  abar filtering (keristofer) ")
print(" ")
print("   chanel rubika = @aqa_keristofer  ")
print(" ")
print(f"{green} ")
print(" cod server ")
time.sleep(0.1)
...
time.sleep(2.0)
if up == "1":
        print(' cod account = (8.5.2.5/h///y/i/i/o.5.3.2.5.8.9.7.5.2.3.7.8.7.4.3.2(fil.rubika.gif.sxs.com).6.4.3.6.5)')
if up != "1":
        print(' cod filter account ')
if up == "2":
        print(' cod gap = (9.4.7.0/h///y/i//g.4.3.4.7.9.5.3.1.5/yfttk15s/9.6.4.2.7.5.3.2.6.9.4.2)')
if up != "2":
        print(' cod filter gap ')
if up == "3":
        print(' cod chanel = (2.9.3.1//g/y///i.7.4.2.0.7.5.2.3.6.7.6.4.2.5.5.3(¥)6.3.2.5)')
if up != "3":
...
print("♡Thanks♡")
print(" ip rubika = 5.106.10.226 ")
print(f"{red} ")
print("""  love atrisa 💙  """)
print(" ")
print(" abar filtering rubika aqa amir ( keristofer ) ")
time.sleep(2.0)
